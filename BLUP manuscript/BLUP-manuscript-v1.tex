...
selection with such models is also proposed. Simulations are used to
validate that the proposed models provide unbiased estimation across
realistic parameter values. An extensive Coding tutorial is additionally
provided to aid researchers in applying this method to their own
datasets in R.
\end{abstract}
...
modeling the effects of multivariate selection. Code is also provided on
the accompanying
\href{https://github.com/Jordan-Scott-Martin/Selection-on-RNs}{Github
page} for this manuscript showing how to estimate these models with the
Stan statistical programming language
(\protect\hyperlink{ref-Stan}{Carpenter et al. 2017}) in R
...
compliment models considering selection on multiple RN parameters. To
aid researchers in applying these models to their own datasets, I've
provided detailed R coding tutorials on the accompanying
\href{https://github.com/Jordan-Scott-Martin/Selection-on-RNs}{Github
...
appropriate inverse link function on the link-scale absolute values
(i.e.~original population RN value + expected population RN change on
the latent scale).
